                    ...
                    <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="advisor_thumb">
                            ...
                            <div class="social-info">
                                <a href="detail.php?index=<?=$i?>"><i class="fa fa-facebook"></i></a>
                                <a href="detail.php?index=<?=$i?>"><i class="fa fa-twitter"></i></a>
                                <a href="detail.php?index=<?=$i?>"><i class="fa fa-linkedin"></i></a>
                            </div>
                        </div>
                        <!-- student information -->
                        <div class="single_advisor_details_info">
                            ...
                            <p><?=  calculateAge(groupInfo[$i]['birthdate']) ?></p>
                            <p><?=  calculateBirthDifference(groupInfo[$i]['birthdate']) ?></p>
                            <a href="detail.php?index=<?=$i?>"><?php echo 'Detail' ?></a>
                        </div>
                    </div>
                 </div>
                <?php
